# Porcupine Wake Word Engine + Rhino Speech-To-Intent Engine Demo for Arduino (Mandarin language)
...
3. Search for `Picovoice_ZH`, then click `INSTALL`.
...
1. Open `File`->`Examples`->`Picovoice_ZH`->`MicrocontrollerVoiceAssistantExample`.
